...
type CarouselApiCustom = UseEmblaCarouselType[1]
...
type CarouselProps = {
  ...
  setApi?: (api: CarouselApiCustom) => void
}
...
const CarouselCustom = React.forwardRef<
  HTMLDivElement,
...
>(
  (
    ...
    const onSelect = React.useCallback((api: CarouselApiCustom) => {
      if (!api) {
        return
      }
...
CarouselCustom.displayName = "CarouselCustom"

const CarouselContentCustom = React.forwardRef<
  HTMLDivElement,
...
CarouselContentCustom.displayName = "CarouselContentCustom"
